...
export interface JevPureOptions {
  client: JevClient;
  /** Board representation to put in `state`. Defaults to the semantic one. */
 ...
 *
 * This is the honest measurement of the model as a player — code contributes
 * only the rules and the legal move list, never a ranking. It is capped at
 * Jev's documented 255 options per Choice, which a 10x10 board never reaches.
 */
